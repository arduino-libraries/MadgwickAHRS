...
void Mahony::Mahonyupdate(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz) {
	float recipNorm;
...
void Mahony::MahonyupdateIMU(float gx, float gy, float gz, float ax, float ay, float az) {
	float recipNorm;
